...
arma::mat WellConstraintProjections::build_A_4d(QList<Reservoir::Grid::XYZCoordinate> coords)
{
    arma::vec vec1 = {coords.at(0).x(),coords.at(0).y(),coords.at(0).z()};
    arma::vec vec2 = {coords.at(1).x(),coords.at(1).y(),coords.at(1).z()};
    arma::vec vec3 = {coords.at(2).x(),coords.at(2).y(),coords.at(2).z()};
...
arma::vec WellConstraintProjections::build_b_4d(QList<Reservoir::Grid::XYZCoordinate> coords, double d)
{
    arma::vec vec1 = {coords.at(0).x(),coords.at(0).y(),coords.at(0).z()};
    arma::vec vec2 = {coords.at(1).x(),coords.at(1).y(),coords.at(1).z()};
    arma::vec vec3 = {coords.at(2).x(),coords.at(2).y(),coords.at(2).z()};
...
arma::mat WellConstraintProjections::build_A_3d(QList<Reservoir::Grid::XYZCoordinate> coords)
{
    arma::vec vec1 = {coords.at(0).x(),coords.at(0).y(),coords.at(0).z()};
    arma::vec vec2 = {coords.at(1).x(),coords.at(1).y(),coords.at(1).z()};
    arma::vec vec3 = {coords.at(2).x(),coords.at(2).y(),coords.at(2).z()};
...
arma::vec WellConstraintProjections::build_b_3d(QList<Reservoir::Grid::XYZCoordinate> coords, double d)
{
    arma::vec vec1 = {coords.at(0).x(),coords.at(0).y(),coords.at(0).z()};
    arma::vec vec2 = {coords.at(1).x(),coords.at(1).y(),coords.at(1).z()};
    arma::vec vec3 = {coords.at(2).x(),coords.at(2).y(),coords.at(2).z()};
...
arma::vec WellConstraintProjections::lambdas(QList<Reservoir::Grid::XYZCoordinate> coords, double d)
{
...
QList<QVector3D> WellConstraintProjections::compute_interwell_vector_4d(QList<Reservoir::Grid::XYZCoordinate> coords, double d)
{
...
QList<QVector3D> WellConstraintProjections::compute_interwell_vector_3d(QList<Reservoir::Grid::XYZCoordinate> coords, double d)
{
    // First sets up matrices A and b
