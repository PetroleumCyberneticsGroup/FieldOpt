...
// =========================================================
/*!
 * \brief The WellBlock class represents a single well
 * block. It contains references to any completion defined
 * within it.
 *
...
class WellBlock
{
 ...
 public:
  ...
  // ---------------------------------------------------------
  /*!
   * \brief The DirectionOfPenetration enum indicates the
   * wells direction of penetration through this block.
   * The W value should be used to indicate that the
  ...
  void AddCompletion(
      ::Model::Wells::Wellbore::Completions::Completion *completion);

  // Check if this well block has a completion.
  bool HasCompletion();

  // Get the completion defined for this block.
  Completions::Completion *GetCompletion();

  // Check if this well block has a perforation-type completion.
  bool HasPerforation();

  // Get the perforation defined for this block.
  Completions::Perforation *GetPerforation();
  ...
  // ---------------------------------------------------------
  DirectionOfPenetration directionOfPenetration()
  const { return direction_of_penetration_; }
  ...
  // ---------------------------------------------------------
  void setDirectionOfPenetration(const DirectionOfPenetration dop)
  { direction_of_penetration_ = dop; }
