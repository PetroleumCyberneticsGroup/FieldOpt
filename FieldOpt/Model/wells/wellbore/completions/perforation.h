...
// =========================================================
/*!
 * \brief The Perforation class represents a well
 * perforation. It contains the potentially variable
...
class Perforation : public Completion
{
 public:
  ...
  // ---------------------------------------------------------
  double transmissibility_factor() const
  { return transmissibility_factor_->value(); }

  // ---------------------------------------------------------
  void setTransmissibility_factor(double value)
  { transmissibility_factor_->setValue(value); }
