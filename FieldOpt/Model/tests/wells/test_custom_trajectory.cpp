...
namespace {
    ...
    class CustomTrajectoryCurveTest : public ::testing::Test,
                                public TestResources::TestResourceModel,
                                public TestResources::TestResourceGrids
    {
    protected:
        CustomTrajectoryCurveTest() {
        }

    };

    TEST_F(CustomTrajectoryCurveTest, SimpleBezier) {
...
//  }
    ...
    TEST_F(CustomTrajectoryCurveTest, WellApplication) {
        Paths paths;
        paths.SetPath(Paths::GRID_FILE, TestResources::ExampleFilePaths::grid_5spot_);
        auto settings = Settings::Model(TestResources::TestResourceModelSettingSnippets::custom_trajectory_well(), paths);
