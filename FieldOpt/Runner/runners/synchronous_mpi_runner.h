...
/*!
 * @brief The SynchronousMPIRunner class performs the optimization
 * synchronously in parallel. Depending on the process rank, it will
 * instantiate either an Overseer (rank = 0) to handle optimizer
 * iteraction and logging, or a Worker (rank > 0) to execute
 * simulations.
 *
 * Still todo:
