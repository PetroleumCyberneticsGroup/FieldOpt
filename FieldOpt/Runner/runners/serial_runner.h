...
/*!
 * \brief The SerialRunner class is a very simple implementation
 * of a serial runner. It interacts with the optimizer and starts
 * simulations in series (i.e. it is _very_ slow).
 */
