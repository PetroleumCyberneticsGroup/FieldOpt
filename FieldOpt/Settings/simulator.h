...
/*!
 * \brief The Simulator class contains simulator-specific settings.
 * Simulator settings objects may _only_ be created by the Settings
...
class Simulator
{
 ...
 public:
  ...
  /// Get name of the script to be used to execute simulations.
  ...
  /*! Set driver file path. Used when path is passed by command
      line argument. */
  ...
  QString custom_simulator_execution_script_path() const
  { return custom_exec_script_path_; }
