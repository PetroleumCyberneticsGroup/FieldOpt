...
class Simulator
{
 ...
 public:
  ...
  QString schedule_file_path() const {return schedule_file_path_; } //!< Get the path to the file containing the schedule section (or the part of it that is to be manipulated).
