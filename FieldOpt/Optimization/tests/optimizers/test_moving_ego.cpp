...
namespace {
    ...
    class MOVING_EGOTest : public ::testing::Test,
    ...
    TEST_F(MOVING_EGOTest, GaussianProcess) {
...
//    rprop.maximize(gp, 50, 0);
    ...
    TEST_F(MOVING_EGOTest, SingleIteration) {
        test_case_ga_spherical_6r_->set_objective_function_value(- abs(Sphere(test_case_ga_spherical_6r_->GetRealVarVector())));
        Optimization::Optimizer *ego = new BayesianOptimization::MOVING_EGO(settings_ego_max_,
    ...
    TEST_F(MOVING_EGOTest, TestFunctionSpherical) {
        test_case_ga_spherical_6r_->set_objective_function_value(- abs(Sphere(test_case_ga_spherical_6r_->GetRealVarVector())));
        Optimization::Optimizer *ego = new BayesianOptimization::MOVING_EGO(settings_moving_ego_min_,
                                                                     test_case_ga_spherical_6r_,
                                                                     varcont_6r_,
                                                                     grid_5spot_,
                                                                     logger_
