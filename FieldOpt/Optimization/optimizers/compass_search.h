 ...
 * of the Compass Search optimization algorithm
 * described by Torczon, Lewis and Kolda. It is an
 * extension of the abstract GSS class.
 *
 * This algorithm only supports integer and real
 * variables, and not both at the same time.
 *
 * Reference:
 *
 * Kolda, Tamara G., Robert Michael Lewis, and
 *  Virginia Torczon. "Optimization by direct search:
 *  New perspectives on some classical and modern
 *  methods." SIAM review 45.3 (2003): 385-482.
 */
