...
#ifndef FIELDOPT_SUBPROBLEM_LU_H
#define FIELDOPT_SUBPROBLEM_LU_H
...
*/
 ...
 public:
  ...
  void SetCoefficients(Eigen::MatrixXd changes);
  ...
  Subproblem_LU(Settings::Optimizer *settings);
  Subproblem_LU(){};

  void ResetSubproblem_LU();
...
#endif //FIELDOPT_SUBPROBLEM_LU_H
