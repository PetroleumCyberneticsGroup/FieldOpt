 ...
 *
 * It instantiates one well length constraint per well and _one_
 * distance constraint. All the constraints are applied cyclically
 * in a loop until either all constraints are satisfied or the
