...
// from Object).
//
// The class add a reference to all objects when added to the array,
// and releases them when removed from the array.
//
// The class exposes the same public interface as a std::vector, so
// see the STL documentation for documentation on most of the methods.
//
// =================================================================
...
// -----------------------------------------------------------------
// Set the collection to contain the same elements as the passed
// collection
template<typename T>
