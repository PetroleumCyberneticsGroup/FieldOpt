...
//
// Very often used in conjunction with the ref<> class (smart
// pointer) which wraps the reference counting. Thus direct use
// of addRef() and release() is seldom needed.
//
// The copy constructor and assignment operator is disabled by
// default so you will get compiler errors instead of unexpected
// behavior if you pass objects (that derive from Object) by value
// or assign objects.
// ===================================================================
...
//
// Note that unless the define CVF_TRACK_ACTIVE_OBJECT_INSTANCES
// is set to 1, this function will always return an empty set.
// -------------------------------------------------------------------
...
//
// Currently this function utilizes RTTI and typeid to get the
// class names. Data on active instances will only be present
// if CVF_TRACK_ACTIVE_OBJECT_INSTANCES is defined
//
//--------------------------------------------------------------------
