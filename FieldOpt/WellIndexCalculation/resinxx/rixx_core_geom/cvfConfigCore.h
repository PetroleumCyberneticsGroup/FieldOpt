...
//==================================================================
// Define this one to tell windows.h to not define min() and max()
// as macros
...
// Can be used to detect memory leaks in combination with the static
// member functions:
// Object::activeObjectInstances() and Object::dumpActiveObjectInstances()
//
...
// In release builds, tight asserts are disabled by default. Normal
// asserts are still in action (including CVF_FAIL_...)
