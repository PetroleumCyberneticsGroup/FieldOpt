...
// Due to problems with classes with reference member variables
// (e.g. VertexCompactor)
//
// 4514  unreferenced inline/local function has been removed
//
// 4625  copy constructor could not be generated because a
// base class copy constructor is inaccessible
//
// 4626  assignment operator could not be generated because a
// base class assignment operator is inaccessible
//
// 4640  'staticInstance' : construction of local static object
// is not thread-safe -> used by singletons. To be revisited.
//
// 4710  function 'func_name' not inlined
//
// 4711  function 'func_name' selected for automatic inline expansion
//
// 4738  storing 32-bit float result in memory, possible loss
// of performance
//
...
#if (_MSC_VER >= 1600)
// VS2010 and newer
// 4986  'operator new[]': exception specification does not match
...
// The bottom one is the best alternative, but unfortunately doesn't
// work on VS2010
#ifdef WIN32
