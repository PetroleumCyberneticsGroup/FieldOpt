...
//void
//PrimitiveSetIndexedUShort::render(OpenGLContext* oglContext) const {
//
...
//#else
//  glDrawRangeElements(primitiveTypeOpenGL(),
//                      m_minIndex,
//                      m_maxIndex,
//                      numIndices,
//                      GL_UNSIGNED_SHORT,
...
//void PrimitiveSetIndexedUShort::
...
//    if (numIndices > 0) {
//
//      GLuint uiSizeInBytes =
//          static_cast<GLuint>(numIndices*sizeof(GLushort));
//
//      m_indicesBO =
...
// =================================================================
// Get a const ptr to the indices (connectivities) stored
// in this primitive set
