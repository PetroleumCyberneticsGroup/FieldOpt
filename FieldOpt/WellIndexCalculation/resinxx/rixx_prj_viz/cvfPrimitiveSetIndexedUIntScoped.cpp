...
//void PrimitiveSetIndexedUIntScoped::
...
// \warning The current render context must support buffer
// objects (OGL version >= 1.5)
//void PrimitiveSetIndexedUIntScoped::
...
//          static_cast<GLuint>(numIndices*sizeof(GLuint));
//
//      m_indicesBO =
...
// =================================================================
void PrimitiveSetIndexedUIntScoped::setIndices(UIntArray* indices,
                                               size_t firstElement,
                                               size_t elementCount) {
...
// =================================================================
void PrimitiveSetIndexedUIntScoped::setScope(size_t firstElement,
                                             size_t elementCount) {
