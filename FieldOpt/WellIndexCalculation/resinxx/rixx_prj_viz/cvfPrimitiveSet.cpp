...
//
// The indices array will be populated with the connectivities
// for the specified face.
// The connectivity table will have 1, 2, 3 or 4 entries.
// If this primitive set consists of a triangle fan, triangles
// will be returned. In a similar fashion, if the primitive set
// consist of a quad strip, quads will be returned.
void PrimitiveSet::getFaceIndices(size_t indexOfFace,
