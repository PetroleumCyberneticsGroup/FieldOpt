...
// =================================================================
PrimitiveSetIndexedUShortScoped::
PrimitiveSetIndexedUShortScoped(PrimitiveType primitiveType)
...
//void PrimitiveSetIndexedUShortScoped::
//render(OpenGLContext* oglContext) const {
//
...
//  }
//
//  glDrawElements(primitiveTypeOpenGL(),
//                 numIndices,
//                 GL_UNSIGNED_SHORT,
//                 ptrOrOffset);
//
...
// \warning The current render context must support
// buffer objects (OGL version >= 1.5)
//void PrimitiveSetIndexedUShortScoped::
...
//      m_indicesBO =
//          oglContext->resourceManager()->
//              getOrCreateManagedBufferObject(oglContext,
...
// =================================================================
void PrimitiveSetIndexedUShortScoped::setIndices(UShortArray* indices,
                                                 size_t firstElement,
                                                 size_t elementCount) {
...
// =================================================================
void PrimitiveSetIndexedUShortScoped::setScope(size_t firstElement,
                                               size_t elementCount) {
