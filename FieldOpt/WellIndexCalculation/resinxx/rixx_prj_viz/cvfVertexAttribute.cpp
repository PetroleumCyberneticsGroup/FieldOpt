...
// -----------------------------------------------------------------
// \fn
// virtual void VertexAttribute::
// setupAttribPointerBufferObject(OpenGLContext* oglContext,
//                                uint vertexAttributeIndex,
//                                size_t strideInBytes,
//                                size_t bufferOffsetInBytes) const = 0;
//
// Specifies the location within buffer object and data format
// of the array of the vertex attribute
//
...
//
// \warning The caller must ensure that no buffer object is
// currently bound
// -----------------------------------------------------------------
