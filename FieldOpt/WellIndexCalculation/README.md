...
Any file in `resinxx` is originally from the [ResInsight](https://resinsight.org/)
project. The files have been modified to suit our needs for well index calculations.
